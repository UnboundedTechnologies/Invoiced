  ...
  return (
    <Page size="LETTER" style={styles.page} wrap={false}>
      ...
      <Text style={styles.footer} fixed>
        Working copy generated by Invoiced · {boxes.ratesEditionTag} · Box values aggregate
        {boxes.paychequeCount} paycheque{boxes.paychequeCount === 1 ? "" : "s"} with status=issued AND payDate in {taxYear}.
        {"\n"}
        File the slip at canada.ca/en/revenue-agency/services/e-services/web-forms.html. Store the CRA-issued version, not this PDF.
      </Text>
    </Page>
  );
}
  ...
  return (
    <Page size="LETTER" style={styles.page} wrap={false}>
      ...
      <Text style={styles.footer} fixed>
        ...
        {"\n"}
        File the T4 Summary on the same CRA Web Forms submission as the slip. Store the CRA-issued version, not this PDF.
      </Text>
    </Page>
  );
}
